 ...
 *
 * @author Emmanuel Ketcha <e.ketchabepa@m3connect.de>
 */
...
class AddUserCommand extends Command
{
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->io->text([
            ...
            '',
            ' $ php bin/console app:add-user username fullname password email@example.com',
            '',
    ...
    protected function execute(InputInterface $input, OutputInterface $output): void
    {
        ...
        $this->io->success(sprintf('User was successfully created'));
